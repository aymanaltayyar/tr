...
include ("../../application/Database/db_MYSQL.php");
		...
		//	$basearray = $database->getOMInfo($wid);
			...
			$q = "INSERT INTO `odata` (`wref`, `type`, `conqured`, `wood`, `iron`, `clay`, `maxstore`, `crop`, `maxcrop`, `lastupdated`, `loyalty`, `owner`) VALUES ('".$row['id']."','".$row['oasistype']."','0','10000','10000','10000','10000','10000','10000','" . time() . "','2000','4')";
