<div class="wrapper d-flex align-items-stretch">
          ...
          <li><a href="index.php"><?php echo $lang['Admin']['sidebar01']; ?></a></li>
	          <li>
                ...
                <li><a href="?p=recharge">شحن ذهب للاعب</a></li>
	            </ul>
            </li>
	          <li>
            ...
            <li>
	          ...
	          <li><a href="?p=codes">أكواد الذهب</a></li>
	          <li><a href="?p=news">قائمة الأخبار</a></li>
	          <li><a href="../dorf1.php"><?php echo $lang['Admin']['sidebar27']; ?></a></li>
	          <li><a href="?action=logout"><?php echo $lang['Admin']['sidebar28']; ?></a></li>
	        </ul>
