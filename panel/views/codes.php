...
<div class="card">
<div class="card-header">توليد أكواد</div>
    ...
    if(isset($_POST) && !empty($_POST)){
        ...
        if(is_numeric($_POST['goldAmount']) && is_numeric($_POST['codeNum'])){
            ...
            if($_POST['goldAmount'] > 0){
                echo '<div class="alert alert-success">قائمة الأكواد:<br>';
...
<div class="form-group">
    ...
    <div class="form-group">
        <button class="btn btn-primary">توليد</button>
    </div>
</form>
</div>
</div>
...
<table cellpadding="1" cellspacing="1" class="table mt-5 mb-5" class="inbox">
    <thead>
    <tr>
			<th colspan="10">قائمة الأكواد</th>
		</tr>
    ...
    if(count($codes) > 0){
        ...
        <td><a href="index.php?p=codes&del=<?php echo $code['id']; ?>"><button class="btn btn-danger">حذف</button></a></td>
        </tr>
    <?php 
        }
        }else{
            echo '<tr><td colspan="6">لا يوجد أكواد بعد.</td></tr>';
        } ?>
    </tbody>
</table>
