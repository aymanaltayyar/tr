...

{
...

	{
		...
		<table class="table" cellpadding="1" cellspacing="1" >
			...
			<thead>
				...
				<tr>
					...
					<th colspan="3">معلومات القرية</th>
			...
			<tbody>
				...
				<tr>
					...
					<?php if($_SESSION['access'] == 9){ ?><td>صاحب القرية:</td>
					...
					<td>
						...
						<form action="../application/panel/Mods/editVillageOwner.php" method="POST" accept-charset="UTF-8">
							...
							صاحب القرية (id): <input class="text" type="text" name="newowner" value="<?php echo $user['id']; ?>"><input type="image" value="submit" src="../img/Admin/edit.gif">
				...
				<tr>
					...
					<td>السكان <a href="index.php?action=recountPop&did=<?php echo $_GET['did']; ?>"><?php echo $refreshicon; ?></a></td>
					...
					<td>النقاط الحضارية <a href="index.php?action=recountCp&did=<?php echo $_GET['did']; ?>"><?php echo $refreshicon; ?></a></td>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><img class="r1" src="../img/x.gif"> الخشب</td>
				...
				<tr>
					...
					<td><img class="r2" src="../img/x.gif"> الطين</td>
				...
				<tr>
					...
					<td><img class="r3" src="../img/x.gif"> الحديد</td>
				...
				<tr>
					...
					<td><img class="r4" src="../img/x.gif"> القمح</td>
              ...
              <a href="index.php?p=villagelog&did=<?php echo $_GET['did']; ?>">بيانات القرية</a>
		...
		<table class="table">
			...
			<thead>
				...
				<tr>
					...
					<th colspan="5">التوسع</th>

				</tr>

				<tr>

					<td class="hab">القرية</td>

					<td class="hab">السكان</td>

					<td class="hab">النقاط الحضارية يوميا</td>
		...
		<table class="table" cellpadding="1" cellspacing="1" >
			...
			<thead>
				...
				<tr>
					...
					<td class="hab">الاسم</td>

					<td class="hab">الاحداثيات</td>

					<td class="hab">الولاء</td>

					<td class="hab">الموارد</td>
			...
			<tbody>
				...
				<?php
...

					{
						...
						echo '<td colspan="5"><center>لم تحتل القرية واحات</center></td>';
		...
		if($_SESSION['access'] == 9){ ?><a href="index.php?p=doublelog&did=<?php echo $_GET['did']; ?>"> سجل الواحات</a>
...
<a href="index.php?p=editVillage&did=<?php echo $_GET['did']; ?>" title="Edit Village">&nbsp;<big> Нарисовать/срисовать домики</big></a>
