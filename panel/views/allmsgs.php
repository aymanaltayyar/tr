...
?>
<div class="card">
    <div class="card-header">الرسالة - <?php echo $msg[0]['topic'];?></div>
    <div class="card-body">
        <p>المرسل: <a href="../spieler.php?uid=<?php echo $database->getUserField($msg[0]['owner'],'id',0);?>"><?php echo $database->getUserField($msg[0]['owner'],'username',0);?></a></p>
        <p>مرسلة إلي: <a href="../spieler.php?uid=<?php echo $database->getUserField($msg[0]['target'],'id',0);?>"><?php echo $database->getUserField($msg[0]['target'],'username',0);?></a></p>
    <hr>
...
?>
<div class="card">
    <div class="card-header">قائمة رسائل الاعبين</div>
...
?>.....</td>
                    <td><input type="button" style="width:100%" name="btn" value="حذف" id="submitBtn" data-toggle="modal" data-target="#deleteMSG<?php echo $ms['id']; ?>" class="btn btn-danger" /></td>
                </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">هل أنت متأكد من حذف الرسالة؟ البيانات غير قابلة للإستعادة بعد الحذف.
                        <hr>
                        عنوان الرسالة: <?php echo $ms['topic']; ?>
                    </div>
