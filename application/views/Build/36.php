            ...
            <tr>
                <div class="buildActionOverview trainUnits">
                    <div class="action">
                        <div class="details">
                            <div class="tit">
                                <a href="#" onclick="return Travian.Game.iPopup(36, 4);"><img class="unit u99" src="img/x.gif" alt="فخ"></a>
                                <a href="#" onclick="return Travian.Game.iPopup(36, 4);">فخ</a>
                                <span class="furtherInfo">(متوفر:  <?php echo $village->unitarray['u99']; ?>)</span>
                            </div>
                            ...
                            <span class="value">الكمية</span> <input type="text" class="text" name="t999" value="0" maxlength="<?=MAXLENGHT?>"><span class="value">
