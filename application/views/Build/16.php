            ...
            if(count($enforcetome) > 0) {
                ...
                $colspan = 10+$enforce['u11'];
                    if($enforce['from']!=0){
                        ...
                        $tribe ? $output .= "<a href=\"karte.php?d=".$enforce['from']."\">".$info['name']."</a>" : $output .= 'وحوش';
                        
                        $output .= "</td><td colspan=\"".$colspan."\">";
                        $output .= "قوات ".$info['username'];
...
<div id="raidList">
    ...
    if(!$session->goldclub) {
        ?>
    <div class="build_desc"><p>نادي الذهب , يتيح لك إخفاء القوات وتهريبها لخارج القرية عند حصول هجمات على القرية</p>
            ...
            <div class="button-content">نادي الذهب</div></div></button>
