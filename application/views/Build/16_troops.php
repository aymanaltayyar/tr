            ...
            <tbody class="infos"><tr><th>الإستهلاك</th>
            <td colspan="<?php echo $coolspan; ?>">
            <div class="sup"><div class="inlineIconList supplyWrapper"><div class="inlineIcon resources"><span class="value "><?php echo $database->getUpkeep($village->unitarray,$tribe,$village->resarray); ?></span><i class="r4"></i></div></div>&nbsp;في الساعه</div>
            </td></tr>
