...
//echo $bindicate; die();
    ...
    if($bindicate == 2 || !$bindicate) {
    	...
    	echo "<span class=\"none\">ستتوفر الموارد في  ".$neededtime[0]." الساعة  ".$neededtime[1]."</span>";}
    }
    else if($bindicate == 8) {
        if($id <= 18) {
...
<div class=\"button-container addHoverClick\" style=\"margin:1px -3px;\">
 ...
 if($id <= 18) {
    ...
    <div class=\"button-background\">
        ...
        echo "</div></div></button>";
        //echo "<span class=\"none\">(قائمة الإنتظار)</span>";
    }
if($bindicate == 88 || $session->goldclub && $building->master==0 && $bindicate < 8) {
    if($bindicate != 88){echo "</br><br>";}
        ...
        echo "</div></div></button>";
        //echo "<span class=\"none\">مساعد البناء <font color='#B3B3B3'>(costs: <img src='img/x.gif' alt='' class='gold' />0)</font></span>";
...
</div> <?php if($bindicate == 9) { echo "<span class=\"none\">(انتظار)</span>"; } ?> 
</div>
