...
<div class="clear"></div>
	<h4 class="round">تدريب المستوطنين</h4>
    ...
    <form method="POST" name="snd" action="build.php">
                    ...
                    if ($slots['settlers']>0  || $slots['chiefs']>0 ) {
                        ...
                        echo "<div class=\"action first\">
                                ...
                                <a href=\"#\" class=\"zoom\" onclick=\"return Travian.Game.unitZoom(".$unit.", 1);\">
                                    <img class=\"zoom\" src=\"img/x.gif\" alt=\"تكبير\">
                                </a>
                                </div>
                                <div class=\"details\">
                                <div class=\"tit\">
                                    ...
                                    <span class=\"furtherInfo\">(متوفر:  ".$village->unitarray['u'.($unit-($session->tribe-1)*10)].")</span>
                                </div>
                        ...
                        echo "<div class=\"status none\"></div><span class=\"value\">الكمية</span>
        ...
        <button type="submit" name="s1" id="btn_train" value="ok" class="green startTraining">
            <div class="button-container addHoverClick ">
                ...
                </div><div class="button-content">تدريب</div>
            </div>
        </button>
