		<div class="contentNavi subNavi ">
				<div class="container <?php if(!isset($_GET['t']) || $_GET['t'] == 0){ echo "active";}else{ echo "normal"; }?>">
					...
					<div class="content favor favorKey0 favorActive"><a href="build.php?id=<?php echo $id; ?>" class="tabItem">إعدادات</a></div>
				</div>
				...
				<div class="container <?php if(isset($_GET['t']) && $_GET['t'] == 3){ echo "active";}else{ echo "normal"; }?>">
					<div class="background-start">&nbsp;</div>
					<div class="background-end">&nbsp;</div>
					<div class="content favor favorKey1"><a href="build.php?t=3&id=<?php echo $id; ?>" class="tabItem">محاكي المعركة</a></div>
				</div>
						...
						if ($('buttonr9NmGApXEAEZH')) {
							$('buttonr9NmGApXEAEZH').addEvent('click', function () {
								window.fireEvent('tabClicked', [this, {
									"class": "gold normal",
									"title": "قائمة المزارع||لهذه الميزة تحتاج إلى نادي الذهب.",
									"target": false,
