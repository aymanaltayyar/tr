...
if($village->resarray['f'.$id] >= 10) {
	?>
	<h4 class="round">هدم المباني:</h4>
	<p>إن لم تكن بحاجة لمبنى يمكنك هدمة من هنا:</p>
...
<div class="demolishNow">
		...
		<div class="button-content">الهدم بالكامل<img src="img/x.gif" class="goldIcon" alt=""><span class="goldValue"><?php echo DEMOLISH_FULL; ?></span></div></div></button>
