...
?>
    ...
    <?php
        ...
        echo "<span class=\"none\">Нехватает еды. Развивайте фермы.</span>";
    }
    else if($bindicate == 5) {
        echo "<span class=\"none\">Развивайте Склад.</span>";
    }
    else if($bindicate == 6) {
        echo "<span class=\"none\">Развивайте Амбар.</span>";
    }
    else if($bindicate == 7) {
        $neededtime = $building->calculateAvaliable($id,$village->resarray['f'.$id.'t'],1+$loopsame+$doublebuild+$master);
        if($neededtime==0){echo "<span class=\"none\">Достаточно ресурсов Никогда</span>";}else{
            echo "<span class=\"none\">Достаточно ресурсов  ".$neededtime[0]." в  ".$neededtime[1]."</span>";}
    }
    else if($bindicate == 8) {
