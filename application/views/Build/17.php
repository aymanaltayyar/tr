...
if(!isset($_GET['t']) || !in_array($_GET['t'],array(1,2,3,4,5))){
    ?>
    <div class="clear"></div>
    <h4 class="round">التجارة الخاصه</h4>
 ...
 ?>
    التجارة الحرة: &lrm;<?php echo $market->merchantAvail(); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    تجار في السوق: &lrm;<?php echo count($market->onmarket); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    تجار على الطريق: &lrm;<?php echo count($market->return) + count($market->sending); ?>/<?php echo $market->merchant; ?>    &lrm;
</div>
<div class="npcMerchant">
     قم بإعادة توزيع مواردك في قريتك باستخدام تاجر المبادلة الآن فوراً وبنسبة 1:1.<br>
