        ...
        <tr>
            <td colspan="2">
                <div id="merchantsNeeded">
                    التجار: <span id="merchantsNeededNumber">0</span>
                </div>
            </td>
                        <td>
...
<div class="clear"></div>
    ...
    <p>طريق تجاري <select class="markgos" name="send3"><option value="1" selected="selected">1x</option><option value="2">2x</option><option value="3">3x</option></select></p>
<?php
}else{
?>
<input type="hidden" name="send3" value="1">
    ...
    <div id="button">
        ...
        <button type="submit" value="إرسال" id="enabledButton" class="green prepare" onclick="if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}" tabindex="10" onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;">
            <div class="button-container addHoverClick">
                <div class="button-background">
                    <div class="buttonStart">
                        <div class="buttonEnd">
                ...
                <div class="button-content">إرسال</div>
            </div>
        </button>
        <script type="text/javascript">
