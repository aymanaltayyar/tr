...
<div class="tradeReport" style="margin-top:-10px;">
    <div class="tradeHeader">
        ...
        <div class="participants">
            <div class="from">
                &nbsp;<a class="player" href="spieler.php?uid=<?php echo $database->getUserField($dataarray[0],"id",0); ?>"><?php echo $database->getUserField($dataarray[0],"username",0); ?></a><br><span>من</span><br><a class="village" href="karte.php?d=<?php echo $dataarray[1]."&amp;c=".$generator->getMapCheck($dataarray[1]); ?>"><?php echo $database->getVillageField($dataarray[1],"name"); ?></a>            </div>
            <div class="to">
                &nbsp;<a class="player" href="spieler.php?uid=<?=$dataarray[8]?>"><?=$dataarray[9]?></a><br><span>إلي</span><br><a class="village" href="karte.php?d=<?=$dataarray[6]?>"><?=$dataarray[7]?></a>            </div>
        </div>
    </div>
