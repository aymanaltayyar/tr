...
<div id="reportWrapper">
    ...
    <div class="supportReport" style="margin-top:-10px;">
        <div class="supportHeader">
            <div class="headline"><h2 class="from">المرسل</h2>
                <h2 class="to">
            ...
            <div class="participants">
                ...
                <?php if($tribe == 4){
                    ?>
                <a class="player" href="spieler.php?uid=3">التتار</a><br><span>من</span><br><a class="village" href="karte.php?x=<?php echo $oCoor['x']; ?>&amp;y=<?php echo $oCoor['y']; ?>"><?php echo UNOCCUPIEDOASES; ?> (<?php echo $oCoor['x']; ?>|<?php echo $oCoor['y']; ?>)</a></div>
                    <?php
                }else{
                    ?>
                    <a class="player" href="spieler.php?uid=<?=$dataarray[0]?>"><?=$dataarray[1]?></a><br><span>من</span><br><a class="village" href="karte.php?d=<?php echo $dataarray[2]; ?>&amp;c=<?php echo $generator->getMapCheck($dataarray[2]); ?>"><?php echo $dataarray[3]; ?></a></div>
                    <?php
                }
                   ?>
                <div class="to">
                    <a class="player" href="spieler.php?uid=<?=$dataarray[20]?>"><?=$dataarray[21]?></a><br><span>إلي</span><br><a class="village" href="karte.php?d=<?=$dataarray[18]?>"><?=$dataarray[19]?></a>
					</div>
            </div>
        </div>
