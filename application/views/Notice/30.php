...
<div id="reportWrapper">
    ...
    <div class="body">
        ...
        <?php $oCoor = $database->getCoor($dataarray[11]); ?>
            ...
            من الواحة <a class="" href="karte.php?x=<?php echo $oCoor['x']; ?>&amp;y=<?php echo $oCoor['y']; ?>">&lrm;&#8237;<span class="coordinates coordinatesWrapper"><span class="coordinateX">(<?php echo $oCoor['x']; ?></span><span class="coordinatePipe">|</span><span class="coordinateY"><?php echo $oCoor['y']; ?>)</span></span>&#8236;&lrm;</a>        </div>
    </div>
