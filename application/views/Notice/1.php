...
<div id="reportWrapper">
    ...
    <div class="header">
        <div class="avatar">
            ...
            <img src="img/svg/combat/svgAttack.svg" alt="هجوم">
        </div>
        <h2>هجوم</h2>
        <div class="outcome">
        ...
        <?php if($dataarray[0] == $session->uid){ ?>
            ...
            <a class="iconButton" title="إعادة الهجوم" href="build.php?t=2&id=39&z=<?php echo $dataarray[39]; ?>&nid=<?php echo $_GET['id']; ?>&re"><i style="top:-3px" class="simulate"></i></a>
        <?php } ?>
        </div>
...
for($i=$start;$i<=($start+9);$i++) {
	...
	echo "<td class=\"uniticon last\"><img src=\"img/x.gif\" class=\"unit uhero\" title=\"البطل\" alt=\"Hero\" /></td>";
...
?>
   ...
   <div class="header">
        <div class="avatar">
            <i class="tribeIcon bigTribe2"> </i>
            <img src="img/svg/combat/svgDefend.svg" alt="دفاع">
        </div>
        <h2>دفاع</h2>
        <div class="outcome">
            <div class="arrowWrapper">
    ...
    <div class="troopHeadline ">
        ...
        <?php if($dataarray[41]==$y+1){ echo'<a class="player" href="spieler.php?uid='.$dataarray[37].'">'.$dataarray[38].'</a> من <a class="village" href="karte.php?d='.$dataarray[39].'&amp;c='.$generator->getMapCheck($dataarray[39]).'">'.$dataarray[40].'</a></p>'; } else { echo OTPRAV2; } ?>
            </div>
