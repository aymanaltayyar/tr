    ...
    <div class="header">
        ...
        <div class="toolList">
            <?php if($dataarray[0] == $session->uid){ ?>
                <a class="iconButton" title="إعادة الهجوم" href="build.php?t=2&id=39&z=<?php echo $dataarray[29]; ?>&nid=<?php echo $_GET['id']; ?>&re"><i style="top:-3px" class="simulate"></i></a>
            <?php } ?>
        </div>
    </div>
...
echo "</tr></tbody>"; ?>
    ...
    <div class="troopHeadline ">
        <div style="direction: rtl">
        <a class="player" href="spieler.php?uid=<?php echo $dataarray[27]; ?>"><?php echo $dataarray[28]; ?></a> من <a class="village" href="karte.php?d=<?php echo $dataarray[29]; ?>&amp;c=<?php echo $generator->getMapCheck($dataarray[29]); ?>"><?php echo $dataarray[30]; ?></a></p>
            </div>
