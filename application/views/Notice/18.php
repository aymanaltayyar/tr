 ...
 ?>
    ...
    <div class="troopHeadline ">
        ...
        <?php if($dataarray[37]==$y+1){ 
            echo'<a class="player" href="spieler.php?uid='.$dataarray[33].'">'.$dataarray[34].'</a> من <a class="village" href="karte.php?d='.$dataarray[35].'&amp;c='.$generator->getMapCheck($dataarray[35]).'">'.$dataarray[36].'</a></p>'; 
        } else {
             echo rpts5.'</p>'; 
             } ?>
            </div>
