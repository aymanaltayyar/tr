    ...
    <div class="detailImage">
        <div id="options">
            ...
            <?php }
                ...
                <div class="option">
                    ...
                    if($uinfo['access']=='0' || $uinfo['access']=='8' || $uinfo['access']=='9') {
                        ...
                        echo $village->resarray['f39']? "<a class=\"a arrow\" target=\"_top\" href=\"build.php?t=2&id=39&z=".$getd."\"> ".KAR9."</a>" : "<span class=\"a arrow disabled\">".KAR9." (".KAR8.")</span>";
                    } else {

                        echo "<span class=\"a arrow disabled\" title=\"الاعب تحت حماية المبتدئين\">".KAR9."</span>";
                    }
                    ?>
                </div>
                <div class="option">
            ...
            <?php }else if ($basearray['occupied']==1 && $basearray['oasistype']!=0 && $basearray['wref'] != $_SESSION['wid']) { ?>
                ...
                <div class="option">
                    <?php
                    echo $village->resarray['f39']? "<a class=\"a arrow\" target=\"_top\" href=\"build.php?t=2&id=39&z=".$d."\">".logint419."</a>" : "<span class=\"a arrow disabled\" title=\"(ابني نقطة تجمع)\"><?=logint419?></span>";
                    ?>
                </div>
            <?php } ?>
            <br>
            <?php if($session->goldclub){ ?>
                ...
                if($fList['id']){ 
                    if(($uinfo['ptime'] > time() || $uinfo['protect']==1)){
                        echo "<span class=\"a arrow disabled\" title=\"الاعب تحت حماية المبتدئين\">إضافة مزرعة للقائمة</span>";
                    }else{
                    ?>
                    <a href="build.php?id=39&t=99&action=showSlot&lid=1&vid=<?php echo $getd; ?>&sort=distance&direction=asc"><span class="a arrow GoldClub">إضافة مزرعة للقائمة</span></a>
                <?php } }else{ ?>
                    <span class="a arrow disabled" title="أنشيء قائمة مزارع أولا من نقطة التجمع">إضافة مزرعة للقائمة</span></span>
...
<div id="oasis1InstantTabs" class="instantTabs">
            <div class="contentNavi tabNavi tabSubWrapper">
                ...
                <!--<div title="" class="container normal">
                    ...
                    <div class="content">
                        ...
                        <a id="buttong2" href="#"" class="tabItem">
                            الجوار                                                                </a>
                    </div>
                </div>-->
    ...
    <table cellpadding="0" cellspacing="0" id="troop_info" class="rep transparent">
        ...
        <?php if($query != 0){
            ...
            ?>
<tbody><tr><td>لا معلومات<br>متاحة !</td></tr></tbody>
            <?php
        } ?>
    </tbody>
