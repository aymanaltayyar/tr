...
<div class="detailImage">
    <div id="options">
        ...
        <?php }else if ($basearray['occupied']==1 && $basearray['oasistype']!=0 && $basearray['wref'] != $_SESSION['wid']) { ?>
            ...
            <div class="option">
                <?php
                echo $village->resarray['f39']? "<a class=\"a arrow\" href=\"build.php?t=2&id=39&z=".$d."\">ارسال قوات.</a>" : "<span class=\"a arrow disabled\" title=\"(ابني نقطة تجمع)\">".OTPRAV1."</span>";
                ?>
            </div>
        <?php } ?>
        <br>
        ...
        <div class="option"><span class="a arrow needGoldClub" id="raidListButtonNoGoldClub">إضافة مزرعة للقائمة</span></div>
