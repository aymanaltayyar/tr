...
<table width="100%" cellpadding="1" cellspacing="1" >
    <tr><thead>
        ...
        <td  class="tdc" width="20%">Количество</td>
...
<br/>
<br /><center> В случае возникновения вопросов обращайтесь к <a onclick="Travian.Game.PopupMessage('?t=1&id=6')">Администратору</a></center>
<br><center>Золото зачисляется на аккаунт сразу после оплаты. </center>
<br><br /><br /><center>Остаток золота с прошлого раунда вы можете перевести через <a target="_blank" href="http://x<?php echo SPEED ?>.xtravian.ru/plus.php?id=6">Банк</a></center><br>
<?php } if ($language == 'en'){?>
	<style>
    .tdc{text-align:center;}
</style>
