...
if($aantal > 0){
	...
	<td><div class="mov"><span class="'.$aclass.'">'.$aantal.'&nbsp;'.$short.'</span></div><div class="dur_r">في&nbsp;<span class="timer" counting="down" value="'.(min($NextArrival)-time()).'">'.$generator->getTimeFormat(min($NextArrival)-time()).'</span>&nbsp;'.HOURS.'</div></div></td></tr>';
	$timer += 1;
}
...
if($aantal > 0){
	...
	echo '<tr><td class="typ"><a href="build.php?t=1&id=39"><img src="img/x.gif" class="'.$action.'" alt="'.$title.'" title="'.$title.'" /></a><span class="'.$aclass.'">&raquo;</span></td>
	<td><div class="mov"><span class="'.$aclass.'">'.$aantal.'&nbsp;'.$short.'</span></div><div class="dur_r">في&nbsp;<span class="timer" counting="down" value="'.(min($NextArrival1)-time()).'">'.$generator->getTimeFormat(min($NextArrival1)-time()).'</span>&nbsp;'.HOURS.'</div></div></td></tr>';
	$timer += 1;
}
...
if($aantal > 0){
	...
	echo '<tr><td class="typ"><a href="build.php?t=1&id=39"><img src="img/x.gif" class="'.$action.'" alt="'.$title.'" title="'.$title.'" /></a><span class="'.$aclass.'">&raquo;</span></td>
	<td><div class="mov"><span class="'.$aclass.'">'.$aantal.'&nbsp;'.$short.'</span></div><div class="dur_r">في&nbsp;<span class="timer" counting="down" value="'.(min($NextArrival2)-time()).'">'.$generator->getTimeFormat(min($NextArrival2)-time()).'</span>&nbsp;'.HOURS.'</div></div></td></tr>';
	$timer += 1;
}
   ...
   if($countoas > 0){
	...
	echo '<tr><td class="typ"><a href="build.php?t=1&id=39"><img src="img/x.gif" class="'.$action.'" alt="'.$title.'" title="'.$title.'" /></a><span class="'.$aclass.'">&raquo;</span></td>
	<td><div class="mov"><span class="'.$aclass.'">'.$countoas.'&nbsp;'.$short.'</span></div><div class="dur_r">في&nbsp;<span class="timer" counting="down" value="'.(min($NextArrival7)-time()).'">'.$generator->getTimeFormat(min($NextArrival7)-time()).'</span>&nbsp;'.HOURS.'</div></div></td></tr>';
	$timer += 1;
}
...
if($lala > 0){
	...
	echo '<tr><td class="typ"><a href="build.php?t=1&id=39"><img src="img/x.gif" class="'.$action.'" alt="'.$title.'" title="'.$title.'" /></a><span class="'.$aclass.'">&raquo;</span></td>
	<td><div class="mov"><span class="'.$aclass.'">'.$lala.'&nbsp;'.$short.'</span></div><div class="dur_r">في&nbsp;<span class="timer" counting="down" value="'.(min($NextArrival3)-time()).'">'.$generator->getTimeFormat(min($NextArrival3)-time()).'</span>&nbsp;'.HOURS.'</div></div></td></tr>';
	$timer += 1;
}
