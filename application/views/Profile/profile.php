...
<form action="spieler.php" method="POST">
    ...
    <table cellpadding="1" cellspacing="1" id="editDetails" class="transparent">
        ...
        <?php if($userv['birthday'] != 0){$bday = explode("-",$userv['birthday']); }else{$bday = array('','','');} ?>
            ...
            <th class="gender" rowspan="2">الجنس</th>
            <td class="gender" rowspan="2">
                <label>
                    <input class="radio" type="radio" name="mw" value="0" <?php if($userv['gender'] == 0) { echo "checked"; } ?> tabindex="5">
                    لا توجد بيانات                    </label><br>
                <label>
                    <input class="radio" type="radio" name="mw" <?php if($userv['gender'] == 1) { echo "checked"; } ?> value="1">
                    محارب                    </label><br>
                <label>
                    <input class="radio" type="radio" name="mw" <?php if($userv['gender'] == 2) { echo "checked"; } ?> value="2">
                    محاربه                    </label>
            </td>
        </tr>
