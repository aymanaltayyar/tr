...
if($_POST) {
    /*
Array ( [ft] => p2 [uid] => 6 [nr0] => 1 [linkname0] => [linkziel0] => [nrNew] => Array ( [0] => 0 ) [linknameNew] => Array ( [0] => تقارير التحالف ) [linkzielNew] => Array ( [0] => allianz.php?s=3 ) [usedRecommended] => yes )
...
<div class="boxes boxesColor gray recommendedLinks">
	...
	<div class="boxes-contents cf">
		<div class="switchWrap">
			<div class="openedClosedSwitch switchOpened" id="linkRecommendationsToggle">الروابط الموصى بها</div>
			<div class="clear"></div>
		</div>
		<div id="linkRecommendations" class="">
			هذه الروابط وجدت انها مفيدة من قبل العديد من اللاعبين. إضافتها إلى قائمة الروابط الشخصية الخاصة بك.			<table class="transparent" cellpadding="1" cellspacing="1" id="recommendedLinks">
				<tbody>
				<tr id="recommendedLinksRow0">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="أسئلة ترافيان" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="نظرة عامة على القرية" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="نظرة عامة على المستودعات" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="تقارير التحالف" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="القرى المجاورة" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="الخيارات" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                ...
                </tr><!--<tr id="recommendedLinksRow6">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="التواصل الإجتماعي" maxlength="30" disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="http://forum.ttwars.com/*" maxlength="255" disabled="disabled">
                    </td>
                    <td class="add">
                        <button type="button" class="addElement " onclick="takeOverRecommendedLink('6')"></button>
                    </td>
                </tr>-->				</tbody>
			</table>
		</div>
