...
<div class="boxes buildingList">
    ...
    <div class="boxes-contents cf">
		...
		<div class="button-content">بناء على الفور</div></div></button>
    ...
    window.addEvent('domready', function()
        ...
        foreach($building->buildArray as $jobs) {
            ...
            if($jobs['master'] == 0){
                ...
                echo "<span class=\"none\">".$building->procResType($jobs['type'])."</span> <span class=\"lvl\"> مستوي ".$jobs['level']."</span> <small><span class=\"none\">".BUILDING_ARCHITECT." <font color=\"#B3B3B3\">(التكلفة: <img src=\"img/x.gif\" alt=\"\" class=\"gold\"> 1)</font></span></small></div><div class=\"clear\"></div></li>";
            }
                $jj++;
                echo '</ul>';
            }
