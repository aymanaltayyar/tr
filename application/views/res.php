...
<ul id="stockBar">
    ...
    <li id="stockBarFreeCropWrapper"  class="stockBarButton r5">
        ...
        <span id="stockBarFreeCrop" class="value" style="font-size: 8px;"><?php echo $village->getProd("crop"); ?></span>
            <a href="production.php?t=5" title="القمح المجاني||إحتياطي القمح: <?php echo number_format($village->getProd("crop")); ?><br>اضغط هنا لمزيد من المعلومات"><img src="img/x.gif" alt=""></a>
        </div>
        <div class="end"></div>
    </li>
