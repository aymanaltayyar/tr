...
$query = count($sql); // دریافت تعداد کوئری ها از دیتابیس
...
include_once "application/views/Auction/alt.php";
	...
	$outputList .= "<td class=\"time".$sStyle."\"><span class=\"timer\" counting=\"down\" value=\"".$timer."\">".$generator->getTimeFormat($time-time())."</span></td>";
	$outputList .= "";
