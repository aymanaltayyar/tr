...
<td class="checkbox">
        ...
        ?>
                ...
                ?>
                <a href="karte.php?d=<?php echo $towref; ?>">واحة</a>
                <!--
...
?>
			...
			<td class="action">
				...
				<a class="arrow" href="#" onclick="window.location.href = 'build.php?gid=16&t=99&action=showSlot&eid=<?php echo $id; ?>&sort=distance&direction=asc'; return false;">تعديل</a>
			</td>
            </tr>
...
?>
    ...
    <div class="markAll">
		...
		<?php } ?>
        <label for="raidListMarkAll<?php echo $lid; ?>">تحديد الكل</label>
    </div>
...
<?php } }?>
<div id="raidList"><div class="options"><a class="arrow" href="#" onclick="Travian.Game.RaidList.showCreateNewList()">إنشاء قائمة جديدة</a></div></div>
<?php
}


//на сворачивание разворачивание
...
?>
    ...
    <?php if(isset($_GET['p'])){
        echo '<br><span style="color:red;">أنت مازلت تحت حماية المبتدئين</span>';
    }
 } ?>
