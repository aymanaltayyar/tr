...
<div id="messageNavigation">
    <div id="backToInbox">
        <a href="nachrichten.php">العودة إلي صندوق الوارد:</a>
    </div>
    <div class="clear"></div>
</div>
                    ...
                    <div id="message_container" class="bbEditor"><div class="boxes boxesColor gray">
                                ...
                                <div class="boxes-contents cf">
                                    <div id="message_toolbar" class="bbToolbar">
                                        ...
                                        <button type="button" class="icon bbButton bbAlliance bbType{d} bbTag{alliance}" title="التحالف">
                                            <img src="img/x.gif" class="bbAlliance" alt="bbAlliance">
                                        </button>
                                        <button type="button" class="icon bbButton bbPlayer bbType{d} bbTag{player}" title="الاعب">
                                            <img src="img/x.gif" class="bbPlayer" alt="bbPlayer">
                                        </button>
                                        <button type="button" class="icon bbButton bbCoordinate bbType{d} bbTag{x|y}" title="الإحداثيات">
                                            <img src="img/x.gif" class="bbCoordinate" alt="bbCoordinate">
                                        </button>
                                        <button type="button" class="icon bbButton bbReport bbType{d} bbTag{report}" title="تقرير">
                                            <img src="img/x.gif" class="bbReport" alt="bbReport">
                                        </button>
                                        <button type="button" id="message_resourceButton" class="icon bbWin{resources} bbButton bbResource" title="الموارد">
                                        ...
                                        <button type="button" id="message_troopButton" class="icon bbWin{troops} bbButton bbTroops" title="القوات">
                                            <img src="img/x.gif" class="bbTroops" alt="bbTroops">
                                        </button>
                                        <button type="button" id="message_previewButton" class="icon bbButton bbPreview" title="معاينة">
                                        ...
                                        <div id="message_toolbarWindows" class="bbToolbarWindow">
                                            <div id="message_resources">
                                                <a href="#" class="bbType{o} bbTag{l}">
                                                    <img src="img/x.gif" class="r1" alt="الخشب">
                                                </a>
                                                <a href="#" class="bbType{o} bbTag{cl}">
                                                    <img src="img/x.gif" class="r2" alt="الطين">
                                                </a>
                                                <a href="#" class="bbType{o} bbTag{c}">
                                                    <img src="img/x.gif" class="r4" alt="الحديد">
                                                </a>
                                                <a href="#" class="bbType{o} bbTag{ir}">
                                                    <img src="img/x.gif" class="r3" alt="القمح">
                                                </a>
                                            </div>
                                            ...
                                            <div id="message_troops">
                                                        ...
                                                        <img class="unit u1" src="img/x.gif" alt="جندي أول">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid2}">
                                                        <img class="unit u2" src="img/x.gif" alt="حراس الإمبراطور">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid3}">
                                                        <img class="unit u3" src="img/x.gif" alt="جندي مهاجم">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid4}">
                                                        <img class="unit u4" src="img/x.gif" alt="فرقة تجسس">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid5}">
                                                        <img class="unit u5" src="img/x.gif" alt="سلاح الفرسان">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid6}">
                                                        <img class="unit u6" src="img/x.gif" alt="فرسان قيصر">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid7}">
                                                        <img class="unit u7" src="img/x.gif" alt="كبش">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid8}">
                                                        <img class="unit u8" src="img/x.gif" alt="المقلاع الناري">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid9}">
                                                        <img class="unit u9" src="img/x.gif" alt="حكيم">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid10}">
                                                        <img class="unit u10" src="img/x.gif" alt="مستوطن">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid11}">
                                                        <img class="unit u11" src="img/x.gif" alt="ابو هراوة">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid12}">
                                                        <img class="unit u12" src="img/x.gif" alt="ابو رمح">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid13}">
                                                        <img class="unit u13" src="img/x.gif" alt="ابو فأس">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid14}">
                                                        <img class="unit u14" src="img/x.gif" alt="الكشاف">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid15}">
                                                        <img class="unit u15" src="img/x.gif" alt="مقاتل القيصر">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid16}">
                                                        <img class="unit u16" src="img/x.gif" alt="فرسان الجرمان">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid17}">
                                                        <img class="unit u17" src="img/x.gif" alt="محطمة الأبواب">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid18}">
                                                        <img class="unit u18" src="img/x.gif" alt="المقلاع">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid19}">
                                                        <img class="unit u19" src="img/x.gif" alt="الزعيم">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid20}">
                                                        <img class="unit u20" src="img/x.gif" alt="مستوطن">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid21}">
                                                        <img class="unit u21" src="img/x.gif" alt="الكتيبة">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid22}">
                                                        <img class="unit u22" src="img/x.gif" alt="المبارز">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid23}">
                                                        <img class="unit u23" src="img/x.gif" alt="المستكشف">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid24}">
                                                        <img class="unit u24" src="img/x.gif" alt="الرعد">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid25}">
                                                        <img class="unit u25" src="img/x.gif" alt="فرسان السلت">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid26}">
                                                        <img class="unit u26" src="img/x.gif" alt="فرسان الليل">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid27}">
                                                        <img class="unit u27" src="img/x.gif" alt="محطمة الأبواب الخشبية">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid28}">
                                                        <img class="unit u28" src="img/x.gif" alt="المقلاع الحربي">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid29}">
                                                        <img class="unit u29" src="img/x.gif" alt="رئيس">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid30}">
                                                        <img class="unit u30" src="img/x.gif" alt="مستوطن">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid31}">
                                                        <img class="unit u31" src="img/x.gif" alt="الجرذ">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid32}">
                                                        <img class="unit u32" src="img/x.gif" alt="العنكبوت">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid33}">
                                                        <img class="unit u33" src="img/x.gif" alt="الثعبان">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid34}">
                                                        <img class="unit u34" src="img/x.gif" alt="الخفاش">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid35}">
                                                        <img class="unit u35" src="img/x.gif" alt="الخزير البري">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid36}">
                                                        <img class="unit u36" src="img/x.gif" alt="الذئب">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid37}">
                                                        <img class="unit u37" src="img/x.gif" alt="الدب">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid38}">
                                                        <img class="unit u38" src="img/x.gif" alt="التمساح">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid39}">
                                                        <img class="unit u39" src="img/x.gif" alt="النمر">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid40}">
                                                        <img class="unit u40" src="img/x.gif" alt="الفيل">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid41}">
                                                        <img class="unit u41" src="img/x.gif" alt="جندي قاتل">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid42}">
                                                        <img class="unit u42" src="img/x.gif" alt="محارب الشوك">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid43}">
                                                        <img class="unit u43" src="img/x.gif" alt="حارس التتار">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid44}">
                                                        <img class="unit u44" src="img/x.gif" alt="طائر التجسس">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid45}">
                                                        <img class="unit u45" src="img/x.gif" alt="فارس الفؤوس">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid46}">
                                                        <img class="unit u46" src="img/x.gif" alt="فارس التتار">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid47}">
                                                        <img class="unit u47" src="img/x.gif" alt="فيل تحطيم الأبواب">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid48}">
                                                        <img class="unit u48" src="img/x.gif" alt="مقلاع تتاري">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid49}">
                                                        <img class="unit u49" src="img/x.gif" alt="إمبراطور تتاري">
                                                    </a>
                                                                                                    <a href="#" class="bbType{o} bbTag{tid50}">
                                                        <img class="unit u50" src="img/x.gif" alt="مستوطن تتاري">
                                                    </a>
                                                                                                <a href="#" class="bbType{o} bbTag{hero}">
                                                    <img class="unit uhero" src="img/x.gif" alt="البطل">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    Travian.Translation.add(
            {
                'nachrichten.adressbuch': 'دليل العناوين',
                'allgemein.save': 'حفظ'
            });
    window.addEvent('domready', function () {
