    ...
    <div class="boxes boxesColor gray">
        ...
        <div class="boxes-contents cf">
            <table id="troop_info" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td>
                        <img class="att_all" src="img/x.gif" alt="قوة القتال"><?php echo ${'u'.$idTroop}['atk']; ?></td>
                    <td>
                        <img class="def_i" src="img/x.gif" alt="قوة القتال ضد"><?php echo ${'u'.$idTroop}['di']; ?></td>
                    <td>
                        <img class="def_c" src="img/x.gif" alt="قوة القتال ضد"><?php echo ${'u'.$idTroop}['dc']; ?></td>
                    <td>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="boxes-contents cf">
            <table class="troopData" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    ?>
                    <td><img class="clock" src="img/x.gif" alt="الوقت"><?php echo $dur; ?></td>
                </tr>
                </tbody>
            </table>
            <div class="clear"></div>
