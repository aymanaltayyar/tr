			...
			<script type="text/javascript">
				window.addEvent('domready', function () {
					Travian.Translation.add(
						{
							'hero_collapsed': 'عرض المعلومات',
							'hero_expanded': 'إخفاء المعلومات'
						});
...
<div id="sidebarBoxAlliance" class="sidebarBox   ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
		<div class="buttonsWrapper">
            <button type="button" id="button5225ee283d5ac" class="layoutButton embassyWhite green <?php if(!$posolstvo || !$session->alliance){ echo "disabled";}?>"  title="السفارة" onclick="<?php echo $link;?> return false;">
                <div class="button-container addHoverClick">
                    <i></i>
                </div>
            </button>
    ...
    <button type="button" id="button5225ee283d8f8" <?php if($posolstvo>0){echo "title='منتدي التحالف || الذهاب لمنتدي التحالف'";} ?>  class="layoutButton overviewWhite green <?php if(!$session->alliance) echo "disabled"; ?> " onclick="return false;">
                <div class="button-container addHoverClick ">
                    <i></i>
                </div>
            </button>
        ...
        <div class="sidebarBoxInnerBox">
            ...
            <div class="innerBox content">
                <ul>
                    ...
                    if(ARTEFACTS>time()) {
                        echo "<li>تبقي على ظهور التحف <span class=\"timer\" counting=\"down\" value=\"".(ARTEFACTS-time())."\">".$generator->getTimeFormat((ARTEFACTS-time()))."</span> ساعة.</li>";
                     }
                     if(WW_PLAN>time()) {
                        echo "<li>تبقي على ظهور مخططات البناء <span class=\"timer\" counting=\"down\" value=\"".(WW_PLAN-time())."\">".$generator->getTimeFormat((WW_PLAN-time()))."</span> ساعة.</li>";
                     }
            ...
            <div class="innerBox footer">
                ...
                <script type="text/javascript">
                    window.addEvent('domready', function()
                    {
                        Travian.Translation.add(
                            {
                                'infobox_collapsed': 'عرض المزيد من الرسائل',
                                'infobox_expanded': 'إخفاء الرسائل'
                            });
                ...
                jQuery(function () {
                    ...
                    Travian.Game.Layout.setupInfoboxItemsDeletionWithMessage('هل تريد حذف هذه الرسالة نهائياً ؟', 'تـأكيد');
                });
            </script>
            </div>
        </div>
...
<div id="sidebarBoxLinklist" class="sidebarBox   ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
		<div class="buttonsWrapper">
        <button type="button" id="buttonSbCOS5JTM2euX" title="قائمة الروابط||تحرير قائمة الروابط" class="layoutButton edit<?php if($session->plus){ echo 'White green'; }else{ echo 'Black gold'; } ?> " onclick="return false;">
                <div class="button-container addHoverClick">
                    <i></i>
                </div>
            </button>
                ...
                <?php if($session->plus){ ?>
                    ...
                    $('buttonSbCOS5JTM2euX').addEvent('click', function () {
                        window.fireEvent('buttonClicked', [this, {
                            ...
                            "redirectUrlExternal": "",
                            "title": "قائمة الرابط || تحرير قائمة الروابط"
                        }]);
                    });
                }
                ...
                if ($('buttonSbCOS5JTM2euX')) {
                    $('buttonSbCOS5JTM2euX').addEvent('click', function () {
                        window.fireEvent('buttonClicked', [this, {
                            ...
                            "redirectUrl": "",
                            "redirectUrlExternal": "",
                            "plusDialog":{"featureKey":"linkList","infoIcon":"http:\/\/t4.answers.travian.us\/index.php?aid=Help#go2answer"},"title": "قائمة الرابط || بلس يسمح لك بإضافة قائمة الروابط"
                        }]);
                    });
                }
            <?php } ?>
