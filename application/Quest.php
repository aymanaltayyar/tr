...
Class Quest{
    ...
    public function questData($id, $type=FALSE){
        ...
        if(!is_numeric($id)){
            ...
            <h4 class="round">معركة
                <!--<div class="categoryProgress"> '.(($session->qArrayB1[0] < $session->qArrayB2[0] ? $session->qArrayB1[0] : $session->qArrayB2[0])-1).'/15</div>-->
            </h4>
            <ul>
            '.($bAll == 0 ? 'لقد أنهيت مهمات المعركة' : ''.($firstBid != 0 ? '<li class="questName" data-questId="Battle_'.($firstBid).'" data-category="battle"><img src="img/x.gif" alt="Reward Pending"><a href="#" class="arrow quest">'.$lang['quests']['monitor']['battle'][($firstBid)].' </a></li>' : '').'
            ...
            <h4 class="round">إلتجارة
            </h4>
            <ul>
            '.($eAll == 0 ? 'لقد أنهيت مهمات التجارة' : ''.($firstEid != 0 ? '<li class="questName" data-questId="Economy_'.($firstBid).'" data-category="economy"><img src="img/x.gif" alt="Reward Pending"><a href="#" class="arrow quest">'.$lang['quests']['monitor']['economy'][($firstEid)].' </a></li>' : '').'
            ...
            <h4 class="round">العالم
            </h4>
            <ul>
            '.($wAll == 0 ? 'لقد أنهيت مهمات التجارة' : ''.($firstWid != 0 ? '<li class="questName" data-questId="World_'.($firstWid).'" data-category="world"><img src="img/x.gif" alt="Reward Pending"><a href="#" class="arrow quest">'.$lang['quests']['monitor']['world'][($firstWid)].' </a></li>' : '').'
                ...
                $html = '
                    <div class="questWrapper">
                        ...
                        <div class="questImage">
                            <img id="questLogo" src="img/x.gif" class="enumerableElementsImage '.$this->getimgClass($questId, $session->qData['isFinished'],$type).'" style="" alt="مرحباً">';
                                ...
                                if ($(\'questTutorialLightBulb\')) {
                                    $(\'questTutorialLightBulb\').addEvent(\'click\', function () {
                                        window.fireEvent(\'buttonClicked\', [this, {
                                            ...
                                            "questButtonActivateTips": "عرض التلميحات",
                                            "questButtonDeactivateTips": "إخفاء التلميحات"
                                        }]);
                                    });
                                }
                            </script>
                            <div class="questTipsToggleDescription">التلميحات تشغيل / إيقاف</div>
                            <div class="clear"></div>
                            </div>').'
                            ';
                            }
                        ...
                        if(!$type){
                            if($id == 1 || $session->isFinished || $session->qData['skipped'] == 1){
                                ...
                                <div class="button-content">'.($session->qData['skipped'] ? 'إحصل على المكافئة' : 'متابعة').'</div></div></button>
                            ...
                            if($id == 1){
                                ...
                                <div class="button-content">تجنب المهام</div></div></button>
                            ...
                            if($type != 0 && (${$firstPart . $qID}[1])){ // Battle
                                if($type == 1){
                                    ...
                                    <div class="button-content">إحصل على المكافئة</div></div></button>
                                <script type="text/javascript" id="buttonKkfN39DhHoNFH_script">
                                window.addEvent(\'domready\', function()
                                    {
                                    if($(\'buttonKkfN39DhHoNFH\'))
                            ...
                            <div class="button-content">نظرة عامة</div></div></button>
    ...
    public function achQuest($id){
        ...
        $html = '<div class="questWrapper achievements">
                ...
                <hr class="achievementLine ">
                <div class="questImage"><img id="questLogo" src="img/x.gif" class="enumerableElementsImage achievementQuest_'.$idAdd.'" style="" alt="انهاء مغامرة">
                </div>
                <div class="questText">
                    <div class="questDescription">
                    ...
                    <div class="questAchievementPoints">
                        <strong>'.$lang['quests']['achievements'][$id]['toDo'].'<br>
                            <br>النقاط الممنوحة في هذه المهمة + '.$acData['a'.$id].' / 5</strong>
                    </div>
                    <hr class="achievementLine">
                    <div class="questDifficulty">
                        <strong>
                            <div id="questDifficulty" class="enumerableElementsDiscription " style="" title="">
                                الصعوبة: <span class="difficulty moderate">'.$lang['quests']['achievements'][$id]['questIn']['Hard'].'</span>
                                <br>
                                <br>المتطلبات : '.$lang['quests']['achievements'][$id]['questIn']['needReq'].'</div>
                        </strong>
                    </div>
                    <hr class="achievementLine ">
                </div>
                <div class="clear"></div>
                <div class="questButtons">
                    <button type="submit" value="نظرة عامة" id="button7ap01epurLstn" class="green questButtonOverviewAchievements" questbuttonoverviewachievements="1" onclick="return false;">
                        <div class="button-container addHoverClick">
                            <div class="button-background">
                                <div class="buttonStart">
                                    <div class="buttonEnd">
    ...
    public function dailyReward($type){
        ...
        if(is_numeric($type) && $type <= 4){
            ...
            $html = '<div class="questWrapper achievements">
                ...
                <hr class="achievementLine">
                <div class="questImage"><img id="questLogo" src="img/x.gif" class="enumerableElementsImage AchievementQuestReward_0'.$type.'" style="" alt="'.($type * 25).' نقاط جمعت">
                </div>
                <div class="questDescription">
                    <div id="questDescription" class="enumerableElementsDiscription " style="" title="">كونك قمت بتجميع '.($type * 25).' نقاط/نقطة اليوم، تحصل على ما يلي '.($type * 25).'<br>
                    ...
                    <h3 class="questRewardTitle">عند جمع '.($type * 25).' نقطة، يمكنك تلقّي واحدة من المكافآت التالية:</h3>
                    ';
                    if($type == 3){
