...
Class Ajax{
    function finishNowPopup(){
        ...
        $html = '<div id="finishNowDialog">
            <p>سيتم الانتهاء من الأوامر التالية على الفور:</p>
                    <h5>المباني:</h5>
                <ul>';
        ...
        $html .= '</ul>
                ...
                <div class="button-content">إستخدام<img src="img/x.gif" class="goldIcon" alt=""><span class="goldValue">2</span></div></div></button>
            ...
            window.addEvent(\'domready\', function()
                ...
                {
                    window.fireEvent(\'buttonClicked\', [this, {"value":"\u0625\u0633\u062a\u062e\u062f\u0627\u0645","name":"","class":"gold ","confirm":"","onclick":"","wayOfPayment":{"featureKey":"finishNow","context":"finishNow"},"title":"\u0627\u0644\u0628\u0646\u0627\u0621 \u0627\u0644\u0643\u0627\u0645\u0644 \u0639\u0644\u0649 \u0627\u0644\u0641\u0648\u0631","coins":2,"id":"buttoncZnsicna05VJf"}]);
                });
                }
                });
            </script>    </div>
